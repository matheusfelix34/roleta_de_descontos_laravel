...
<head>
  ...
  {{-- <link href="{{ asset('js/vue.min.js') }}" rel="stylesheet" /> --}}
    ...
    <div class="columns">
      <div class="column">
        <div class="columns is-centered">
          ...
          <input type="button" class="button is-dark" value="Girar roleta" id='spin' v-on:click="spin"/>  
        </div>
        <div class="columns is-centered">
      ...
      <div class="column">
        <div class="columns is-multiline">
          <div class="column is-half">
            <div class="field">
              <input class="input" type="number" placeholder="Escreva o valor do desconto" v-model="new_option" v-on:keyup.enter="addOptions" >
             
            </div>
          </div>
          <div class="column is-half">
            <button class="button is-primary" v-on:click="addOptions">Adicione desconto</button>
          </div>
 ...
 var app = new Vue({
  ...
  methods: {
    ...
    stopRotateWheel: function () {
      ...
      text.font='bold 15px Helvetica, Arial';
      console.log(index, text, this.options," em disconto");
      var texto=" de desconto";
      var moeda="R$ ";


      this.ctx.fillText(moeda+text+texto , 200 - this.ctx.measureText(text).width / 2, 250 + 10);
      this.ctx.restore();
    },
